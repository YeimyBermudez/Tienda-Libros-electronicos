                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Ingrese el nombre del libro que desea.">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            ...
                            $db = new dataBase();
                            $db->conectar();
                            $rec = $db->consultar("categorias", "id_categoria", $id_categoria);
                            while ($row = mysqli_fetch_array($rec)) {
                                $id_cat = $row['0'];
                                $nom_cat = $row['1'];
                                ?>
                                <h2 class = "title text-center"><?php echo $nom_cat ?> </h2>
                                <?php
                            }
                            ?>
                            <?php
                            ...
                            $db = new dataBase();
                            $db->conectar();
                            $rec = $db->consultar("libros", "id_categoria", $id_categoria);
                            while ($row = mysqli_fetch_array($rec)) {
                                $id_libro = $row['0'];
                                        ...
                                        <div class = "single-products">
                                            ...
                                            <div class = "product-overlay">
                                                <div class = "overlay-content">
                                                    <p>Autor : <?php echo $autor_libro ?></p>
                                                    <p>Editorial:<?php echo $editorial_libro ?></p>
                                                    <form id = "nuevoUsuario" method = "post" action = "eventos.php" >
                                                        <button class="btn btn-agregarC btn-large" name="agregarCarrito" value="<?php echo $id_libro ?>"> <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"> Agregar a carrito</span></button>  
                                                    </form>
